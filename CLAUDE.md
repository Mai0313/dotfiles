...
| `wcl.c.googlers.com` (Cloudtop VM, `asia-east1-b`) | `is_work && linux` | AMD EPYC (`n2d-custom-128-245760`), 128 vCPU, KVM guest | 240 GiB configured, swap TBD | 8 TB PD_SSD, single boot disk | none (headless) | Debian rodete (`family-1-track-3`), kernel TBD | 2026-08-26 (`ct get`, not booted yet) |

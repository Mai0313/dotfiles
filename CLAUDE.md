...
| `wcl.c.googlers.com` (Cloudtop VM, `asia-east1-b`) | `is_work && linux` | AMD EPYC 7B13, 2 sockets × 32C / 128T, KVM guest | 236 GiB + 229 GiB swap | 8 TB PD_SSD, network-backed (LVM root 7.7 TB) | none (headless, virtio only) | Debian rodete, kernel 7.1.6 | 2026-08-26 |
